...
Ensure the `homepage` field in your `package.json` file is correctly set to your GitHub Pages URL:
"homepage": "https://kunalchachane0.github.io/Personal_portfolio",
...
This will build your project and push it to the `gh-pages` branch of your repository. Your site will be live at the `homepage` URL.
